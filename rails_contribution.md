...
* Railsのcore memberの一人であるXavier Noria(@fxn)が作成したサイト
...
* 適当なIssueをピックアップしてバグフィックスしてみる
  * コードを見る際の取っ掛かりとしてIssueを利用する
* 意外とやってみると簡単に直せるバグもある
...
* git log + pecoでコミットログを検索できるようにしてる
